            ...
            <div class="about-a1" >
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="title-box">
                                <h2 class="btn-info">Instalasi Farmasi RSI Yatofa Melayani Anda Adalah Kemuliaan Kami</h2>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row align-items-center about-main-info">
                                <div class="col-lg-6 col-md-6 col-sm-12 " ng-app="myApp" ng-controller="customersCtrl">
                                    <h2 align="center">Panggilan Atas Nama :</h2>
                                    </br><!-- comment -->
                                    </br><!-- comment -->
                                    </br><!-- comment -->
                                ...
                                <button class="bg-danger" align="center"><h2>Silahkan Ke Loket Pengambilan Obat</h2></button>
                                </div>
                                
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="about-m">
                                        <ul id="banner" style="height: 400px">
                                            <li>
